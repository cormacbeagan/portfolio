export const text = {
  ...
  paragraphOne:
    "Munich based freelance web developer. Originally from Edinburgh, Scotland I have dual Irish British citizenship and grew up on a farm. You can see some of my earlier work in my projects and for any questions or comments please don't hesitate to drop me a line.",
  projects: [
    {
      name: 'visit munich',
      links: [
  ...
  stack: {
    ...
    js: {
      heading: 'Javascript',
      text: "Because vanilla is the best flavour. Having worked with JS fora couple years now with numerous small projects and various courses, I am confident of achieving what I set out to create when I'm in JS land. ",
    },
    html: {
      heading: 'HTML',
      text: 'As the basis of all access to websites, good foundational HTML skills are essential to my toolkit.',
    },
    css: {
      heading: 'CSS',
      text: 'My favorite design tool. Despite a good grasp of vanilla CSS I have to admit I find whole new concepts to wrap my head around every day.',
    },
    react: {
      heading: 'React JS',
      text: `I have truly learned the joy and satisfaction of building things with code through working with React. For an assessment of my skills please refer to the source code for this site, my radio player or my travelers tips site.`,
    },
    node: {
      heading: 'Node JS',
      text: 'With a couple smaller projects completed (cloud functions), I can confidently say I like working with Node, Express and that whole ecosystem.',
    },
    next: {
      heading: 'Next JS',
      text: 'My introduction to next has been building this site, which has been fun. The site is server rendered, uses node serverless functions for sending emails. I look forward to taking advantage of the slick routing when I add separate static pages for the projects, ',
    },
    typescript: {
      heading: 'TypeScript',
      text: "And then JS got clever - having switched to TS a couple months ago, I have to say I'm not going back.",
    },
    styled: {
      heading: 'Styled Components',
      text: 'Discovering Styled Components was a eureka moment, this site is styled exclusively with styled components and I look forward to developing my personal library of components in the coming months.',
    },
  },
};
